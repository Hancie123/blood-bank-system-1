                        ...
                        <div class="settings-wrapper d-flex">
                            ...
                            <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
                                <div class="card-header border-bottom px-0 mx-3">
                                    <h5 class="fw-bold">Create State</h5>
                                </div>
                                <div class="card-body px-0 mx-3">
                                    <form action="{{ url('admin/settings/state-settings') }}" method="POST">
                                        @csrf
                                        <!-- start row -->
                                        <div class="row border-bottom mb-3">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-lg-3">
                                                        <label class="form-label mb-0">Select Country<span
                                                    ...
                                                    <div class="col-lg-9">
                                                        ...
                                                        <select class="form-select" name="country_id">
                                                            @foreach ($countries as $data)
                                                                <option value="{{ $data->id }}">{{ $data->country }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-lg-3">
                                                        <label class="form-label mb-0">State Name<span
                                                                class="text-danger ms-1">*</span></label>
                                                    </div><!-- end col -->
                                                    <div class="col-lg-9">
                                    ...
                                    <table class="table table-striped datatable table-nowrap">
                                        ...
                                        <tbody>
                                            @forelse ($states as $data)
                                                <tr>
                                                    <td>
                                                        {{ $data->id }}
                                                    </td>
                                                     <td>{{ $data->country->country??null }}</td>
                                                    <td>{{ $data->name }}</td>
                                                </tr>
                                            @empty
                                            @endforelse
