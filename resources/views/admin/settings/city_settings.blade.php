                        ...
                        <div class="settings-wrapper d-flex">
                            ...
                            <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
                                <div class="card-header border-bottom px-0 mx-3">
                                    <h5 class="fw-bold">Create City</h5>
                                </div>
                                <div class="card-body px-0 mx-3">
                                    <form action="{{ url('admin/settings/city-settings') }}" method="POST">
                                        @csrf
                                        <!-- start row -->
                                        <div class="row border-bottom mb-3">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-lg-3">
                                                        <label class="form-label mb-0">Select State<span
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-lg-3">
                                                        <label class="form-label mb-0">City Name<span
                                                                class="text-danger ms-1">*</span></label>
                                                    </div><!-- end col -->
                                                    <div class="col-lg-9">
                                    ...
                                    <table class="table table-striped datatable table-nowrap">
                                        ...
                                        <tbody>
                                            @forelse ($cities as $data)
                                                <tr>
                                                    <td>
                                                        {{ $data->id }}
                                                    </td>
                                                     <td>{{ $data->state->name??null }}</td>
                                                    <td>{{ $data->name }}</td>
                                                </tr>
                                            @empty
                                            @endforelse
