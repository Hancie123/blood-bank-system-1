                        ...
                        <tbody>
                            @forelse ($requestBloods as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('request.blood.status.toggle', $data->id) }}"
                                            class="btn btn-sm {{ $data->is_blood_received === 'true' ? 'btn-success' : 'btn-secondary' }}"
                                            onclick="return confirm('Are you sure you want to change the donation status?')">
                                            {{ $data->is_blood_received === 'true' ? 'Received' : 'Not Received' }}
                                        </a>
                                    </td>
